...
enum ts_symbol_identifiers {
  ...
  aux_sym_mGen_repeat1 = 38,
  aux_sym__genDecl_repeat1 = 39,
  aux_sym_packagePath_repeat1 = 40,
  aux_sym__pkgName_repeat1 = 41,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fullCN, 2, 0, 4),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mdf, 1, 0, 0),
  ...
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_alias, 6, 0, 0),
  ...
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 3, 0, 0),
  ...
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__genDecl, 4, 0, 0),
